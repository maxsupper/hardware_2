...
| L3-可复现-mock | PASS | report.json md5=20dc0b08 | 确定性 MOCK 产物 |
| L3-产出齐全 | PASS | 69 个产物文件 | PH-0_输入准备; PH-1_手册检索; PH-2_网表解析; PH-3_深度分析; PH-4_报告合成; PH-5_审计复核; gates; run_manifest.json |