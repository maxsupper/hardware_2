...
| L2-负向-fault注入(G5缺报告) | PASS | report.json 缺失 → G5 应 FAIL | PH-5_report/report.json |
...
| L3-产出齐全 | PASS | 81 个产物文件 | PH-0_input; PH-1_manual; PH-2_check; PH-3_netlist; PH-4_analyze; PH-5_report; PH-6_audit; PH-7_delivery; gates; run_manifest.json |