...
目录（对齐 rules.json path_map）:
  storge/project/<产品>/PH-0_input .. PH-6_delivery + gates .run(temp+log)
"""
...
STAGE_DIRS = ["PH-0_input", "PH-1_manual", "PH-2_netlist", "PH-3_analyze",
              "PH-4_report", "PH-5_audit", "PH-6_delivery", "gates", ".run/temp"]
