...
目录（对齐 rules.json path_map）:
  storge/project/<产品>/PH-0_输入准备 .. PH-6_闭环交付 + gates .run(temp+log)
"""
...
STAGE_DIRS = ["PH-0_输入准备", "PH-1_手册检索", "PH-2_网表解析", "PH-3_深度分析",
              "PH-4_报告合成", "PH-5_审计复核", "PH-6_闭环交付", "gates", ".run/temp"]
